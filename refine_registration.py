...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Refine registration")
    ...
    parser.add_argument("--icp_method", type=str, default="color", choices=["color", "point_to_plane", "point_to_point", "generalized"], help="ICP method")
    ...
    parser.add_argument("--template_refined_posegraph", type=str, default="scene/refined_posegraph.json")
    ...
    config = {
        ...
        "template_refined_posegraph": args.template_refined_posegraph,
