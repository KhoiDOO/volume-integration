...
if __name__ == "__main__":
    ...
    parser.add_argument("--global_registration", type=str, default="ransac", choices=["ransac", "fgr"], help="Global registration method")
    parser.add_argument("--folder_fragment", type=str, default="fragments/", help="Folder containing fragments")
    parser.add_argument("--folder_scene", type=str, default="scene/", help="Folder to save scene outputs")
    parser.add_argument("--template_fragment_posegraph_optimized", type=str, default="fragments/frag_optimized_%03d.json")
    parser.add_argument("--template_global_posegraph", type=str, default="scene/posegraph.json")
    parser.add_argument("--template_global_posegraph_optimized", type=str, default="scene/posegraph_optimized.json")
    ...
    parser.add_argument("--preference_loop_closure_registration", type=float, default=5.0, help="Preference loop closure registration")
    ...
    config = {
        ...
        "folder_scene": args.folder_scene,
        "template_fragment_posegraph_optimized": args.template_fragment_posegraph_optimized,
        "template_global_posegraph": args.template_global_posegraph,
        "template_global_posegraph_optimized": args.template_global_posegraph_optimized,
        "python_multi_threading": not args.disable_multi_threading,
        "debug_mode": args.debug_mode,
        "preference_loop_closure_registration": args.preference_loop_closure_registration
    }
